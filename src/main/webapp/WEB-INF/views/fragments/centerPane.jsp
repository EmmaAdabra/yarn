...
<div class="flex flex-col gap-5 items-center pt-6 text-main_text max-w-[700px] mx-auto" id="centerPaneContent">
  <div
          class="flex items-center gap-3 bg-bg_color2 px-3 py-2 mb-4 w-full rounded-md shadow-sm shadow-fade_text">
